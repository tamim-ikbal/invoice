...
{
    /**
     * @return array{invoice: InvoiceEditResource, clients: \Illuminate\Http\Resources\Json\AnonymousResourceCollection, statuses: array<int, array{value: string, label: string}>}
     */
    public function handle(Invoice $invoice): array
    {
        $invoice->load(['tasks', 'payments', 'client']);
